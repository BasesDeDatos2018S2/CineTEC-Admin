...
export class ViewSreeningComponent implements OnInit {
  ...
  constructor() {
    ...
    this.screening_to_add = new Screening(0,"","","","");
    this.header_list = [ "Cine","Sala","Película","Horario","",""];
    this.screening_list.push(new Screening(1,"Animales Fantásticos","Cinépolis","1-B","17:30",));
    this.screening_list.push(new Screening(2,"Venom","NovaCinemas","1-C","18:30",));
